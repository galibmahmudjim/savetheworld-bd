            ...
            <>
                  ...
                  <div className="HomeFigure">
                        <div className=" box-container mt-[5vh] bg-[#fcfffc5f] ">
                              ...
                              <div id="leftFigHome" className=" left pointer" >

                                    <svg id="leftSvg"
                                          className="w-[50%] absolute delay-1000"
                                    ...
                                    <ResponsiveContainer width="50%" height='90%' className=' ' >
                                          <BarChart data={data} margin={{ top: 80, right: 30, left: 100, bottom: 5 }}>
                                                ...
                                                <Legend />
                                                <Bar dataKey="AnnualPlasticProduction.Value" name="Annual Plastic Production" fill="#8884d8" />
                                          </BarChart>
                                    </ResponsiveContainer>
                              </div>
                        </div>
