      ...
      return (
            <div className="w-full h-full text-[20px] more">
                  ...
                  <ul className="ulHome">
                        ...
                        <li className="checkmarks">  <HiOutlineClipboardDocumentList color="#3565BE" size={25} /><p className="w-[90%]">Only approximately 10% of total world plastic is recycled.</p></li>
                        <li className="checkmarks">  <HiOutlineClipboardDocumentList color="#3565BE" size={25} /><p className="w-[90%]">Plastic visibility is increasing due to plastic accumulation and its harmful influence on the environment and human health.</p>
                        </li>
                  </ul>
            </div>
      )
